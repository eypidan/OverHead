...
void main(){
    ...
    vec4 vertex_coord_world = model * vec4(vertex_coord, 1.0);
    vec4 camera_coord_world = model * vec4(camera_coord, 1.0);
    vec4 lightPosition_water_world = model * vec4(lightPosition_water, 1.0);
